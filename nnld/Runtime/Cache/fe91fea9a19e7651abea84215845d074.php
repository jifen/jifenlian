...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tab1">
  <tr>
   ...
   <!--   <tr>
        ...
        <td width="27%"><input size="30" name="shopid" type="text" id="shopid" value="<?php echo ($myid); ?>" class="ipt" onBlur="javascript:yhServer(this.name,'0')" /></td>
      ...
      <tr>
        ...
        <td width="27%"><input size="30" name="RID" id="RID" type="text" class="ipt" onKeyUp="guolv(this.name)" onFocus="notice('1','')" onBlur="javascript:yhServer(this.name,'1');notice('1','none')" value="<?php echo ($ben); ?>"/></td>
  ...
  <!--    <tr >
        ...
        <td><input size="30" name="FID" id="FID" type="text"  value="<?php echo ($ben); ?>"  class="ipt" onKeyUp="guolv(this.name)" onFocus="notice('2','')" onBlur="javascript:yhServer(this.name,'2');notice('2','none')" /></td>
      ...
      <tr>
        ...
        <td>
        <input size="30" name="UserID" id="UserID" type="text"  value="<?php echo ($flist['UserID']); ?>" class="ipt" onKeyUp="guolv(this.name)" onFocus="notice('3','')" onBlur="javascript:yhServer(this.name,'3');notice('3','none')"/>
        </td>
...
-->
      ...
      <!--     <tr>
           <td align="right"><span class="zc_hong">*</span>身份证号：</td>
           <td><input size="30" name="UserCode" type="text" class="ipt" id="UserCode" onFocus="notice('11','')"  onblur="notice('11','none')" onKeyUp="javascript:Null_Full(this.name)" value="<?php echo ($regData["user_code"]); ?>" maxlength="18" /></td>
      ...
      <tr>
        ...
        <td><input size="30" name="qq" type="text"  id="qq" class="ipt" onKeyUp="javascript:Null_Int(this.name)" onFocus="notice('16','')"  onblur="notice('16','none')" value="<?php echo ($regData["qq"]); ?>" /></td>
...
-->
        ...
        <!--
                ...
                <tr>
                    ...
                    <td colspan="2">
                     <?php if(is_array($s9)): $i = 0; $__LIST__ = $s9;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$svo): $mod = ($i % 2 );++$i;?><input size="30" name="cpzj" type="radio" <?php if($key == 0): ?>checked="checked"<?php endif; ?> value="<?php echo ($s9[$key]); ?>" />
                        <strong>&nbsp;<span class="STYLE3"><?php echo ($s9[$key]); ?> 元</span>&nbsp;</strong><?php endforeach; endif; else: echo "" ;endif; ?>
                    </td>
                </tr>
   ...
   -->
               ...
               <!--        <tr>
                            <td align="right">申请级别：</td>
                            <td colspan="2">
                            <?php if(is_array($s9)): $i = 0; $__LIST__ = array_slice($s9,0,1,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$svo): $mod = ($i % 2 );++$i; if(($key) == "0"): ?><input size="30" name="u_level" type="radio" id="radio" value="<?php echo ($key); ?>" checked="checked"  />
                            <strong>&nbsp;<span class="STYLE3"><?php echo ($s9[$key]); ?> 元</span>&nbsp;(<span class="STYLE3"><?php echo ($str28[$key]); ?> </span>)</strong>
                            <?php else: ?>
                            <input size="30" name="u_level" type="radio" id="radio" value="<?php echo ($key); ?>"/>
                            <strong>&nbsp;<span class="STYLE3"><?php echo ($s9[$key]); ?> 元</span>&nbsp;(<span class="STYLE3"><?php echo ($str28[$key]); ?> </span>)</strong><?php endif; endforeach; endif; else: echo "" ;endif; ?>
        ...
        <tr>
            <td align="right">申请级别：</td>
            <td colspan="2">
                <?php if(is_array($s9)): $i = 0; $__LIST__ = $s9;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><input size="30" name="cpzj" type="radio" id="radio" value="<?php echo ($s9[$key]); ?>"  <?php if($key == 0): ?>checked="checked"<?php endif; ?>  />
                        <strong><span class="STYLE3"><?php echo ($s9[$key]); ?> 积分</span>[<span class="STYLE3"><?php echo ($str28[$key]); ?> </span>]</strong>&nbsp;&nbsp;&nbsp;<?php endforeach; endif; else: echo "" ;endif; ?>
...
<table width="90%" class="tab3" border="0" cellpadding="3" cellspacing="1" id="tb1" align="center" bgcolor="#b9c8d0">
  ...
  <tr align="center" class="size14">
    ...
    <?php if(is_array($plist)): $i = 0; $__LIST__ = $plist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr align="center">
      <td nowrap height="22"><input style="display:none;" type="checkbox" class="box" name="id[]" value="<?php echo ($vo["id"]); ?>" id="check<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></td>
      <td nowrap height="22"><img src="<?php echo ($vo["img"]); ?>" width="150" height="150"></td>
      <td nowrap><a id="jiaqian<?php echo ($vo["id"]); ?>"><?php echo ($vo["money"]); ?></a></td>
      <td nowrap><input size="30" id="shu<?php echo ($vo["id"]); ?>" name="shuliang[]" type="text" onKeyUp="jia(<?php echo ($vo["id"]); ?>)"  value="0" size="6" maxlength="15" />
        </td>
      <td nowrap><input size="30" class="jais" id="he<?php echo ($vo["id"]); ?>" name="money[]" type="text" size="6" value="0" readonly /></td>

...
<div class="accounttitle"><h1>奖励明细  [<a href='javascript:history.back()'>返回列表</a>] </h1></div>
<table width="100%" class="tab3" border="0" cellpadding="3" cellspacing="1" id="tb1" bgcolor="#b9c8d0">
	...
	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr align="center">
		...
		<!--	<td <?php echo ($c_b[10]); ?>><?php echo ($vo['b10']); ?></td>
            ...
            <td <?php echo ($c_b[13]); ?>><?php echo ($vo['b11']); ?></td>-->
		...
		<td <?php echo ($c_b[12]); ?>><a href="__URL__/financeShow/RDT/<?php echo ($vo['s_date']); ?>/PDT/<?php echo ($vo['e_date']); ?>/UserID/<?php echo ($user_id); ?>" title="这一期明细">明细</a></td>
...
<table width="100%" class="tab3_bottom" border="0" cellpadding="0" cellspacing="1">
    <tr>
    	...
    	<td width="50%"><form id="form1" name="form1" method="post" action="__URL__/financeTable">日期：<input name="FanNowDate" type="text" id="FanNowDate" onclick="laydate()" /> <input type="submit" name="Submit" value="查询" class="button_text" />

...
<table width="100%" class="tab3" border="0" cellpadding="3" cellspacing="1" id="tb1" bgcolor="#b9c8d0">
    ...
    <tr align="center">
     ...
     <!--   <th><span>住址城市</span></th>
      ...
      <!--  <th><span>联系电话</span></th>-->
        <!-- <th><span>分公司</span></th> -->
        <th><span>服务中心资格</span></th>
        <!-- <th><span>注册时间</span></th> -->
        <th><span>开通时间</span></th>
        <th><span>奖励积分</span></th>
        <th><span>注册积分</span></th>


    <!--    <th><span>消费积分</span></th>
        <th><span>活跃积分</span></th>  -->


        <th><span>VAP积分</span></th>
        <!--  <th><span>注册积分</span></th>
          <th><span>B网奖励币 </span></th>
            <th><span>重消积分</span></th>

          <th><span>欠款</span></th>-->
        <!--  <th><span>升级状态</span></th> -->
          <th><span>状态</span></th>
        <th><span>是否奖励</span></th>
        <!--  <th><span>升级设置</span></th>
         <th colspan="2"><span>分红奖</span></th> -->
        </tr>
    </thead>
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="content_td lz" align="center">
        ...
        <td><a href="__URL__/premAdd/id/<?php echo ($vo['id']); ?>/">设置权限</a></td>
    ...
    <!--    <td><?php echo ($vo['shop_name']); ?></td>  -->
     ...
     <!--   <td><?php echo ($vo['agent_xf']); ?></td>
        <td><?php echo ($vo['agent_cf']); ?></td>  -->



        <td><?php echo ($vo['agent_gc']); ?></td>

        <td><?php if(($vo['is_lock']) == "0"): ?>未锁定<?php else: ?>已锁定<?php endif; ?></td>
       <!-- <td><?php echo ($vo['agent_xf']); ?></td>  -->

       <!-- <td><?php if(($vo['is_lock']) == "0"): ?><span style="color: #FF0000;">未锁定</span><?php else: ?>已锁定<?php endif; if(($vo['is_pay']) == "2"): ?>[空单]<?php endif; ?></td> -->


        <td><?php if(($vo['is_fenh']) == "0"): ?><span style="color: #FF0000;">开启奖励</span><?php else: ?>关闭奖励<?php endif; ?></td>
        <!--    <td><a href="__APP__/Uplevel/adminMenberJinjis/id/<?php echo ($vo["id"]); ?>">升级</a> </td>
           <td colspan="2"><?php if(($vo['is_lockfh']) == "0"): ?><span style="color: #FF0000;">开启</span><?php else: ?>关闭<?php endif; ?></td> -->
        </tr><?php endforeach; endif; else: echo "" ;endif; ?>


<tr style="display:none">
<td colspan="14" align="center"><font color="#FF0000">总业绩： <?php echo ($f4_count); ?></font></td>
</tr>
</table>
...
<table width="100%" align="center">
    <tr>
    <td align="center"><form method='post' action="__URL__/adminMenber/">搜索会员：<input type="text" name="UserID" placeholder="请根据选择输入相应的查询" style="width: 180px;">

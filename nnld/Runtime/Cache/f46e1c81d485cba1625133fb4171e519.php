...
<table width="100%" class="tab3" border="0" cellpadding="3" cellspacing="1" id="tb1" bgcolor="#b9c8d0">
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr align="center">
     ...
     <!--    <td><?php echo ($vo['shop_name']); ?></td>  -->
        ...
        <td><?php if(($vo["pdt"]) == "0"): ?>未开通<?php else: echo (date('Y-m-d H:i:s',$vo["pdt"])); endif; ?></td>
        <td>
...
<table width="100%" class="tab3_bottom" border="0" cellpadding="0" cellspacing="1">
    <tr>
        ...
        &nbsp;&nbsp;
        <input type="submit" name="action" value="开通会员" onclick="{if(confirm('确定开通会员吗?')){return true;}return false;}" class="bt_tj">
        &nbsp;&nbsp;
        <input type="submit" name="action" value="删除会员" onclick="{if(confirm('确定删除会员吗?')){return true;}return false;}" class="bt_tj">
         <?php if(($frs["is_agent"]) == "2"): endif; ?>
        </td>
...
<table width="600" align="center">
    ...
    <!--<img src="__PUBLIC__/Images/money_lit.png" align="absmiddle"/>&nbsp;&nbsp;&nbsp;-->  注册积分余额:&nbsp;<span class="hong"><?php echo ($frs['agent_cash']); ?></span><!--&nbsp;&nbsp;&nbsp;电子积分:&nbsp;<span class="hong"><?php echo ($frs['agent_cf']); ?></span>--></td></tr>
</table>
</div>
</body>
</html>

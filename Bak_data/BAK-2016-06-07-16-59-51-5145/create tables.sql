...
CREATE TABLE `nnld_fck` (
  ...
  `agent_gc` decimal(12,8) NOT NULL DEFAULT '0.00000000',
  ...
  `vap_month` decimal(12,8) NOT NULL,
  `vap_amount` decimal(12,8) NOT NULL,
  `vap_xiaofei` decimal(12,2) NOT NULL,
  `month` int(11) NOT NULL,
  `vap_total` decimal(12,8) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `index_cf` (`agent_cf`),
  FULLTEXT KEY `index_p_path` (`p_path`)
) ENGINE=MyISAM AUTO_INCREMENT=11323 DEFAULT CHARSET=utf8;
-- <fen> --
-- 表的结构: nnld_fck2 --
...
-- <fen> --
-- 表的结构: nnld_shifang --
CREATE TABLE `nnld_shifang` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `user_id` varchar(255) NOT NULL,
  `shifang` int(11) NOT NULL,
  `vap` decimal(12,8) NOT NULL,
  `pdt` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
-- <fen> --
...
-- <fen> --
-- 表的结构: nnld_vap --
CREATE TABLE `nnld_vap` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `epoints` int(11) NOT NULL,
  `vap_price` decimal(12,3) NOT NULL,
  `rmb` decimal(12,3) NOT NULL,
  `all_money` decimal(12,8) NOT NULL,
  `get_money` decimal(12,8) NOT NULL,
  `pdt` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
-- <fen> --
...
CREATE TABLE `nnld_xiaoshou` (
  ...
  `is_team_yj` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=11321 DEFAULT CHARSET=utf8;
-- <fen> --
-- 表的结构: nnld_yeji --
